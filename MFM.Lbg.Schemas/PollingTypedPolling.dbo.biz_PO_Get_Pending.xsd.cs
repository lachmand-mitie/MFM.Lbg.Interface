namespace MFM.Lbg.Schemas {
    ...
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "IDOCTYPE", XPath = @"/*[local-name()='TypedPollingResultSet0' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']/*[local-name()='IDOCTYPE' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']", XsdType = @"string")]
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.Int32), "POREF", XPath = @"/*[local-name()='TypedPollingResultSet0' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']/*[local-name()='POREF' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']", XsdType = @"int")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"TypedPollingResultSet0", @"ArrayOfTypedPollingResultSet0", @"TypedPolling"})]
    public sealed class PollingTypedPolling_dbo_biz_PO_Get_Pending : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:element name=""TypedPolling"">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        public PollingTypedPolling_dbo_biz_PO_Get_Pending() {
        }
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending",@"TypedPollingResultSet0")]
        [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "IDOCTYPE", XPath = @"/*[local-name()='TypedPollingResultSet0' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']/*[local-name()='IDOCTYPE' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']", XsdType = @"string")]
        [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.Int32), "POREF", XPath = @"/*[local-name()='TypedPollingResultSet0' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']/*[local-name()='POREF' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']", XsdType = @"int")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending",@"ArrayOfTypedPollingResultSet0")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending",@"TypedPolling")]
        [BodyXPath(@"/*[local-name()='TypedPolling' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']/*[local-name()='TypedPollingResultSet0' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/dbo.biz_PO_Get_Pending']")]
        [System.SerializableAttribute()]
