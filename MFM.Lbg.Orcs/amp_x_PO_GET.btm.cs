namespace MFM.Lbg.Orcs {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"MFM.Lbg.Schemas.VFM_POTypedProcedure_dbo+biz_PO_Get_DataSet", typeof(global::MFM.Lbg.Schemas.VFM_POTypedProcedure_dbo.biz_PO_Get_DataSet))]
    public sealed class amp_x_PO_GET : global::Microsoft.XLANGs.BaseTypes.TransformBase {
  ...
  <xsl:template match=""/s0:TypedPollingResultSet0"">
    <ns0:biz_PO_Get_DataSet>
      <xsl:if test=""s0:POREF"">
        ...
        private const string _strTrgSchemasList0 = @"MFM.Lbg.Schemas.VFM_POTypedProcedure_dbo+biz_PO_Get_DataSet";
        
        private const global::MFM.Lbg.Schemas.VFM_POTypedProcedure_dbo.biz_PO_Get_DataSet _trgSchemaTypeReference0 = null;
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"MFM.Lbg.Schemas.VFM_POTypedProcedure_dbo+biz_PO_Get_DataSet";
                return _TrgSchemas;
            }
        }
    }
